...
void sil()
{
    ...
    printf("Silmek istediginiz musterinin sirasini giriniz(2. musteri ise 2'i tuslayiniz) giriniz==>");//Hocam burdaki hatayı çözemedim sadece sonuncu musteriyi siliyor
    scanf("%d",&no);
    i=no;
